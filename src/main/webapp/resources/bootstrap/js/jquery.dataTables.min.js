...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Sonraki",sPrevious:"Önceki"},sEmptyTable:"No data available in table",sInfo:" _TOTAL_ Ögeden _START_ ile _END_ arası.",sInfoEmpty:"Kayıt bulunamadı.",sInfoFiltered:"(_MAX_ Kayıt arasından.)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Sayfada _MENU_ kayıt göster",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Arama:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Hiçbir eşleşen kayıt bulunamadı."},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
