...
<td><a class="btn btn-info" href="${pageContext.request.contextPath}/admin/productEdit/${i.getUrunID()}"><i class="glyphicon glyphicon-pencil"></i> Düzenle</a></td>
    ...
    <ul class="pagination">
        <c:if test="${currentPage != 1}">
            <li class="page-item"><a class="page-link" 
                href="${pageContext.request.contextPath}/admin/searchUrun?searchVal=${searchVal}&pageId=${currentPage-1}">
        ...
        <c:forEach begin="1" end="${noOfPages}" var="i">
            <c:choose>
                ...
                <c:otherwise>
                    <li class="page-item"><a class="page-link" 
                        href="${pageContext.request.contextPath}/admin/searchUrun?searchVal=${searchVal}&pageId=${i}">${i}</a>
                    </li>
                </c:otherwise>
            </c:choose>
        </c:forEach>
